...
namespace InfoStrat.VE.Utilities
{
    public class AnimateUtility
    {
        ...
        public static AnimationClock AnimateElementDouble(DependencyObject element, DependencyProperty property, double targetValue, double fromTime, double toTime)
        {
            if (!(element is IAnimatable))
            {
                throw new InvalidOperationException("Element must be IAnimatable.");
